...
DROP PROCEDURE IF EXISTS H_Accounting.dotieno_tmp;
DELIMITER $$

-- create store procedure with one paramenter
CREATE PROCEDURE H_Accounting.dotieno_tmp(varCalendarYear SMALLINT)
...
-- insert table title, and units
  INSERT INTO H_Accounting.dotieno_tmp
...
CALL H_Accounting.dotieno_tmp (2019);
...
UNION ALL
SELECT	* FROM H_Accounting.dotieno_tmp;
